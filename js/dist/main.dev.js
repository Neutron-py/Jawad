...
$(function () {
  ...
  ***************************/
  ...
  var groups = gsap.utils.toArray(".mil-accordion-group");
  var menus = gsap.utils.toArray(".mil-accordion-menu");
  ...
  function createAnimation(element) {
    var menu = element.querySelector(".mil-accordion-menu");
    var box = element.querySelector(".mil-accordion-content");
    var symbol = element.querySelector(".mil-symbol");
    var minusElement = element.querySelector(".mil-minus");
    var plusElement = element.querySelector(".mil-plus");
    gsap.set(box, {
      height: "auto"
    });
  ...
  var btt = document.querySelector(".mil-back-to-top .mil-link");
  gsap.set(btt, {
    x: -30,
    opacity: 0
  });
  ...
  var cursor = document.querySelector('.mil-ball');
  gsap.set(cursor, {
    xPercent: -50,
    yPercent: -50
  });
  ...
  var appearance = document.querySelectorAll(".mil-up");
  appearance.forEach(function (section) {
    gsap.fromTo(section, {
      opacity: 0,
      y: 40,
      scale: .98,
  ...
  var scaleImage = document.querySelectorAll(".mil-scale");
  scaleImage.forEach(function (section) {
  ...
  var parallaxImage = document.querySelectorAll(".mil-parallax");

  if ($(window).width() > 960) {
    parallaxImage.forEach(function (section) {
      var value1 = $(section).data("value-1");
      var value2 = $(section).data("value-2");
      gsap.fromTo(section, {
        ease: 'sine',
  ...
  var rotate = document.querySelectorAll(".mil-rotate");
  rotate.forEach(function (section) {
  ...
  var swiper = new Swiper('.mil-infinite-show', (_ref = {
    slidesPerView: 2,
    spaceBetween: 30,
    speed: 5000,
    autoplay: true
    ...
    delay: 0
  }), _defineProperty(_ref, "loop", true), _defineProperty(_ref, "freeMode", true), _defineProperty(_ref, "breakpoints", {
    992: {
      slidesPerView: 4
    }
  }), _ref));
  ...
  document.addEventListener("swup:contentReplaced", function () {
    ...
    var swiper = new Swiper('.mil-infinite-show', (_ref2 = {
      slidesPerView: 2,
      spaceBetween: 30,
      speed: 5000,
      autoplay: true
      ...
      delay: 0
    }), _defineProperty(_ref2, "loop", true), _defineProperty(_ref2, "freeMode", true), _defineProperty(_ref2, "breakpoints", {
      992: {
        slidesPerView: 4
      }
    }), _ref2));
